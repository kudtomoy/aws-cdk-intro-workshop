...
## スタックからサンプルコードを削除するHeader anchor link
...
スタックのコンテンツを変更しました。ツールキットによってCDKアプリケーションと現在デプロイされているものの違いを確認することができます。 これは `cdk deploy` を実行したときに何が起こるかを確認するための安全な方法であり良い習慣です。
